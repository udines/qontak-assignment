...
class MainActivityInteractor {
    ...
    fun getPopularMovies(onFinishedListener: OnFinishedListener, page: Int) {
        ...
        val url =
            Constants.BASE_URL_API + "movie/popular?api_key=" + Constants.API_KEY + "&language=en-US&page=" + page.toString()
    ...
    fun getTopRatedMovies(onFinishedListener: OnFinishedListener, page: Int) {
        ...
        val url =
            Constants.BASE_URL_API + "movie/top_rated?api_key=" + Constants.API_KEY + "&language=en-US&page=" + page.toString()
    ...
    fun searchMovieByTitle(onFinishedListener: OnFinishedListener, page: Int, title: String) {
        val url =
            Constants.BASE_URL_API + "search/movie?api_key=" + Constants.API_KEY + "&language=en-US&query=" + title + "&page=" + page.toString() + "&include_adult=false"
